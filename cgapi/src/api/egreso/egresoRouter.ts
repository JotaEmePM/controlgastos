...
import { CrateEgresoSchema, GetEgresoSchema, EgresoSchema } from './egresoModel'
...
egresoRouter.get(
  '/:id',
  validateRequest(GetEgresoSchema),
  egresoController.getEgreso
)
...
egresoRouter.post(
  '/',
  validatePostRequest(CrateEgresoSchema),
  egresoController.newEgreso
)
