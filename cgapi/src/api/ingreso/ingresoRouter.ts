...
import { CrateIngresoSchema, GetIngresoSchema, IngresoSchema } from "./ingresoModel"
...
ingresoRouter.get("/:id", validateRequest(GetIngresoSchema), ingresoController.getIngreso)
...
ingresoRouter.post("/", validatePostRequest(CrateIngresoSchema), ingresoController.newIngreso)
